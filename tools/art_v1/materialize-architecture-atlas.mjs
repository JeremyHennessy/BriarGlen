...
const parts=Array.from({length:16},(_,i)=>path.join(root,'tools','art_v1',`architecture-atlas-v1.part${String(i+1).padStart(2,'0')}.b64`));
const output=path.join(root,'assets','art-v1','architecture','architecture-atlas-v1.webp');
const expectedSha256='3b7acdac9f3aed323796f34a0ca13492e09e98a436ca099c96bcd43c440e9736';
const expectedBytes=135800,expectedWidth=1024,expectedHeight=1024;

(() => {
  ...
  const state={version:'build47-layer-guard-v3',requested,historicalProof,legacyLayersSuppressed:false};
  if(requested&&legacyGeneratedEnabled){
    ...
    // Historical proof URLs deliberately retain the Build 46 visual stack so its rollback and
    // performance contracts remain independently testable.
